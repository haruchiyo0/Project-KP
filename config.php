...
if ($workTypeCount === 0) {
    ...
    $seedwt->execute(['EXPAND ODP', 'Expansion ODP Field', 125000, 'Penambahan Kapasitas ODP Lapangan']);
}
...
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbzoT1-jAPbE_XSyi7cuxByzDUa1Fl-JpqLaIG3nCtTrISs5S8TfD8nt9GwsUnLTlIa9/exec';
