    ...
    if (!$error) {
        try {
            ...
            $insertJob = $db->prepare(
                'INSERT INTO jobs (reporter_name, reporter_nik, work_type, work_order, no_inet, customer_name, ps_date, description, base_amount, created_by)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'
            );
            $insertJob->execute([$reporterName, $reporterNik, $workType, $workOrder, $noInet, $customerName, $psDate, $description, $baseAmount, $user['id']]);
...
<div class="app-layout">
    <aside class="sidebar">
        ...
        <nav>
            ...
            <?php else: ?>
                <a class="active" href="job-create.php">
